...
import com.example.onedoesnotsimply.inscricoes3.R;
...
public class ListaInscricaoActivity extends Activity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            listView = (ListView) findViewById(R.id.ListViewInscricao);
